...
class Nilai extends Admin_Controller {
    ...
    public function index($offset = 0) {
        ...
        $config['total_rows']           = $this->Nilai_model->count_all($filters);
        ...
        $data['nilai']      = $this->Nilai_model->get_all($filters, $per_page, $offset);
        $data['pagination'] = $this->pagination->create_links();
        $data['kelas']      = $this->Kelas_model->get_all();
        $data['semester_list'] = $this->db->select('semester, tahun_ajaran')->from('nilai')->group_by('semester, tahun_ajaran')->order_by('tahun_ajaran','DESC')->get()->result();
    ...
    public function input_per_siswa() {
        ...
        $semester     = $this->input->get('semester') ?: '1';
